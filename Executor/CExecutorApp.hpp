...
public:
    CExecutorApp();
    virtual ~CExecutorApp();

	void Execute(TaskExecutor::PlanInfo plan);
...
protected:
	...
	std::vector<std::string> vble_list;				//list of OpenMORA variables subscribed to

	TaskExecutor te;
	// DATA. Your local variables here...
	mrpt::synch::CCriticalSection sem_execution;
