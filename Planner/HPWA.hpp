...
public:
	...
	mrpt::synch::CCriticalSection comm_sem;
...
private:
	size_t pet_id;											//Counter for the number of petitions performed to the GetInformation method
	...
	mrpt::synch::CCriticalSection plan_sem;
